...
public class EditAccountActivity extends AppCompatActivity {
    ...
    EditText uname;
    Button btnupdate;
    TextInputEditText email, alamat, ultah;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        date = findViewById(R.id.txt_ultah);
        ...
        dateS = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker datePicker, int y, int m, int d) {
                ...
                TextView dateStart = findViewById(R.id.txt_ultah);
        ...
        date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new DatePickerDialog(EditAccountActivity.this, dateS,
        ...
        ultah=findViewById(R.id.txt_ultah);
                ...
                AuthUI.getInstance()
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            public void onComplete(@NonNull Task<Void> task) {
                                Toast.makeText(EditAccountActivity.this, "User Signed Out", Toast.LENGTH_SHORT).show();
                                Intent i = new Intent(EditAccountActivity.this, HomeActivity.class);
                                startActivity(i);
                            }
                        });
            }
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        uploader.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                map.put("ultah", ultah.getText().toString());
        ...
        dbreference.child(UserID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    ultah.setText(snapshot.child("ultah").getValue().toString());
